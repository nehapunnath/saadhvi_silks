          ...
          <div className="flex flex-col lg:flex-row gap-12">
                ...
                {cartItems.map((item) => (
                  ...
                  >
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="w-8 h-8 flex items-center justify-center bg-rose-50 text-[#891c3c] rounded-full hover:bg-[#891c3c] hover:text-white transition-all duration-300"
                    ...
                    <div className="flex flex-col items-end">
                      <span className="text-[#891c3c] font-bold text-lg mb-2">
            ...
            <div className="lg:w-1/3">
              <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-24">
                ...
                <button
                  className="w-full bg-[#891c3c] text-white px-6 py-3 rounded-full font-medium hover:bg-[#6a1530] transition-all duration-300 mt-6"
                >
                  Proceed to Checkout
                </button>
                <Link
