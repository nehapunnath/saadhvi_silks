        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-3">
              <a
                href="#"
                className="bg-white p-2.5 rounded-full text-[#6B2D2D] hover:bg-[#6B2D2D] hover:text-white transition-all duration-300 shadow-sm"
                aria-label="Facebook"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <svg className="w-4 h-4 text-[#6B2D2D] mt-0.5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li className="flex items-center">
                <svg className="w-4 h-4 text-[#6B2D2D] mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li className="flex items-center">
                ...
                <span className="text-[#2E2E2E] text-sm">infosaadhvisilks@gmail.com</span>
              </li>
            </ul>
          </div>
